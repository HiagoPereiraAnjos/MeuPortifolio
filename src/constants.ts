export const PORTFOLIO_DATA = {
  ...
  projects: [
    {
      ...
      description: "Hoteis perdiam controle de acesso ao cafe da manha e sofriam com filas na operacao. O sistema centraliza hospedes, valida QR em segundos e melhora a previsibilidade entre recepcao e restaurante.",
    ...
    },
    {
      ...
      description: "O fluxo operacional entre PDV, cozinha e caixa gerava atrasos e retrabalho no atendimento. A solucao integra pedidos, comandas e fechamento para reduzir erros e acelerar a operacao.",
    ...
    },
    {
      ...
      description: "A marca precisava converter melhor o trafego organico em oportunidades comerciais. A landing page foi estruturada com SEO tecnico, narrativa objetiva e CTA claro para aumentar conversao.",
  ...
  contact: {
    ...
    whatsapp: "https://api.whatsapp.com/send?text=Ola%20Hiago%2C%20vi%20seu%20portfolio%20e%20gostaria%20de%20falar%20sobre%20um%20projeto.",
